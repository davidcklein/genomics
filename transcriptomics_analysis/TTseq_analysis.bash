...
#These commands will use subread to assign reads to genomic features (annotated transcripts and genes, respectively) for hg38. For most traditional RNAseq analyses, the gene counts file is appropriate. For TT-seq, transcript- and gene-level approaches can both be appropriate, depending on the intended goal. 
