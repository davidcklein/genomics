...
for f in *.fastq; do bowtie2 -q -N 1 -p 8 -X 1000 --no-unal -x $hg38 -U $f -S ${f/.fastq/.sam}; pigz -p 8 -- $f; done 
#Bowtie2 will align fragments up to 1000 bp, leaving unaligned reads out of the output sam files
